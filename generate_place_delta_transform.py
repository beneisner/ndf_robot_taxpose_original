...
def main(args, global_dict):
    ...
    # for iteration in range(len(grasp_demo_filenames)):

    #     grasp_demo_fn = grasp_demo_filenames[iteration]
    #     grasp_data = np.load(grasp_demo_fn, allow_pickle=True)
    #     demo_dict = get_demo_pose_ori(grasp_data, get_jpos=True)
    #     shapenet_id = demo_dict['shapenet_id']
    #     grasp_pos = demo_dict['obj_pos']
    #     grasp_ori = demo_dict['obj_ori']
    #     grasp_robot_jpos = demo_dict['robot_joints']
    ...
    # log_info("#################Demo Place Data#################")
    # # Demo Place Data
    # data_dir = 'train_data_ndf_cons_{}'.format(args.seed)
