...
def main(args, global_dict):
    ...
    # for iteration in[3,4,8,10,14]:
        ...
        print("cloud_colors.shape:{}".format(cloud_colors.shape))
        print("cloud_classes.shape:{}".format(cloud_classes.shape))
        mug_id = 0
        rack_id = 1
        gripper_id = 2
...
if __name__ == "__main__":
    ...
    txt_file_name = "{}.txt".format(args.eval_data_dir)
    # f = open(txt_file_name, "a")
    # f.write("{} \n".format("eval_save_dir"))
    # f.write(eval_save_dir)
    # f.write("\n")
    # f.write("{} \n".format("vnn_model_path"))
    # f.write(vnn_model_path)
    # f.write("\n")
    # f.close()
