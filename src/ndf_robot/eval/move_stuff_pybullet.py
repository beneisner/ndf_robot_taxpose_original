...
def main(args):
    ...
    log_info("pose_pre_transform")
    log_info(util.pose_stamped2list(pose_pre_transform))
    ...
    log_info("pose_pred")
    log_info(util.pose_stamped2list(pose_pred))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='move_stuff_xy')
