...
@hydra.main(config_path="/home/exx/Documents/equivariant_pose_graph/configs/exx/", config_name="exx_dcpflow_residual0_test_ndf_my_model_ablation")
def main(hydra_cfg):
    ...
    for iteration in range(hydra_cfg.start_iteration, hydra_cfg.num_iterations):
        ...
        # rack_relative_pose = util.my_pose_transfer(pose_pred, obj_pose_world)
        ...
        # np.array(pos), np.array(quat), rot_mat, euler
