...
def main(args):
    ...
    for iteration in range(args.iteration):
        ...
        obj_translation, obj_orientation = util.pose_stamped2list(pose_w_yaw)[:3], util.pose_stamped2list(pose_w_yaw)[3:]
        pose_base = util.list2pose_stamped(obj_translation + obj_orientation)
        log_info('obj_translation')
        log_info(obj_translation)
        log_info('obj_orientation')
        log_info(obj_orientation)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='place_test_0_my_model_may11_dgcnn_diffembnntrans_rot180_trainedlonger_minimal')
